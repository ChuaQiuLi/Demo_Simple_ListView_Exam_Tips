package sg.edu.rp.c346.id20007649.demosimplelistviewexamtips;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvExamsTips = findViewById(R.id.listViewExamsTips);
        ...
        lvExamsTips.setAdapter(adapter);
